...
namespace CasaCejaRemake.Services
{
    ...
    public class TicketService
    {
        ...
        public string GenerateTicketText(TicketData ticket, TicketType type, string rfc, string ticketFooter, int lineWidth = 40)
        {
            return type switch
            {
        ...
        /// </summary>
        public string GeneratePaymentTicketText(PaymentTicketData data, string rfc = "", int lineWidth = 40)
        {
