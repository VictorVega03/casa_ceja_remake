...
namespace CasaCejaRemake.Models.DTOs
{
    ...
    // ─── DTOs para PULL de créditos (datos que vienen del servidor) ───

    public class CreditPullDto
    {
        ...
        [JsonPropertyName("months_to_pay")] public int MonthsToPay { get; set; }
        [JsonPropertyName("credit_date")] public DateTime CreditDate { get; set; }
        ...
        [JsonPropertyName("products")] public List<CreditProductPullDto> Products { get; set; } = new();
    }

    public class CreditProductPullDto
    {
    ...
    {
        [JsonPropertyName("folio")] public string Folio { get; set; } = string.Empty;
        [JsonPropertyName("credit_folio")] public string CreditFolio { get; set; } = string.Empty;
        [JsonPropertyName("user_id")] public int UserId { get; set; }
